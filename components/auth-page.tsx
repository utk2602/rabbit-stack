				...
				<div className="mx-auto space-y-4 sm:w-sm">
					...
					<div className="flex flex-col space-y-1">
						...
						<p className="text-base text-muted-foreground">
							Rabbit Stack uses GitHub OAuth and JWT access tokens.
						</p>
					</div>
					{error && (
					...
					<div className="rounded-lg border border-border bg-secondary/60 p-4 text-sm text-muted-foreground">
						No email/password accounts are available. GitHub is the only OAuth
						provider, and signed JWTs are issued from <code>/api/auth/token</code>.
					</div>
