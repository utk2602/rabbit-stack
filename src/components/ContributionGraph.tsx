...
export function ContributionGraph({ calendar }: ContributionGraphProps) {
  ...
  useEffect(() => {
    // Scroll to the end (current date) on mount
  ...
  // Flatten days to find max contributions for scaling
        ...
        <div className="min-w-fit p-4 bg-black border border-zinc-800 rounded-xl">
          <div className="flex flex-col gap-2">
            ...
            <div className="flex gap-1">
              ...
              <div className="flex flex-col gap-1 text-[10px] text-zinc-500 pt-2 pr-2 sticky left-0 bg-black z-10 w-8 shrink-0">
              ...
              <div className="flex gap-0.5">
                {weeks.map((week, weekIndex) => {
                  // Create an array of 7 days, filling missing ones with null to ensure correct alignment
